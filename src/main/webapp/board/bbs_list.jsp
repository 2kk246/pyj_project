...
<%
    ...
    int totalNum = dao.countArticles("전체");//DB에 저장된 총 게시글 숫자
    ...
    if (totalNum > 0) {
        articleList = dao.getArticles(startRow, listSize * currPageNum, "전체");
    }
...
<!-- 게시글 부분 -->
<p class="nameOfBoard">게임 추천 게시판</p>
