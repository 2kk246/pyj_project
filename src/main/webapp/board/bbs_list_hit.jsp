...
<%
    ...
    if (totalNum > 0) {
        articleList = dao.getArticles_hit(startRow, listSize * currPageNum, board);
    }
...
%>
        <a href="bbs_list_hit.jsp?pageNum=<%=i%>"> [<%=i%>] </a>&nbsp;
<%
        }
        ...
        if(startNum > navSize){
%>
        	<a href="bbs_list_hit.jsp?pageNum=<%= (startNum-navSize) %>"> &lt;이전&nbsp;</a> 
<%   
        }
...
%>
            <a href="bbs_list_hit.jsp?pageNum=<%= (endNum+1) %>"> 다음&gt; </a>
<% 
         }
    }
}//else문의 닫힘 괄호
