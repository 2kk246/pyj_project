...
<%
    ...
    int totalNum = dao.countArticles("공포");//DB에 저장된 총 힐링 게시글 숫자
    ...
    if (totalNum > 0) {
        articleList = dao.getArticles(startRow, listSize * currPageNum, "공포");
    }
...
<!-- 게시글 부분 -->
<p class="nameOfBoard">공포 게임 게시판</p>
...
<div style="text-align:right">
	...
	<span>
		...
		<input type="image" src="../img/glass.png" alt="검색" width="30px">
	</span>
	</form>
</div>
<script>
...
%>
        <a href="bbs_list_horror.jsp?pageNum=<%=i%>"> [<%=i%>] </a>&nbsp;
<%
        }
        ...
        if(startNum > navSize){
%>
        	<a href="bbs_list_horror.jsp?pageNum=<%= (startNum-navSize) %>"> &lt;이전&nbsp;</a> 
<%   
        }
...
%>
            <a href="bbs_list_horror.jsp?pageNum=<%= (endNum+1) %>"> 다음&gt; </a>
<% 
         }
    }
}//else문의 닫힘 괄호
